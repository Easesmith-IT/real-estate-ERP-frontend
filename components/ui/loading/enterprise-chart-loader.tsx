        ...
        {type === "area" && (
          <div className="w-full h-full flex flex-col justify-between">
            ...
            <div className="relative w-full h-full flex items-end">
              <svg className="w-full h-[80%] text-accent-primary/10" viewBox="0 0 100 100" preserveAspectRatio="none">
                <defs>
                ...
                <path
                  d="M0,100 L0,60 Q15,30 30,55 T60,25 T90,65 L100,45 L100,100 Z"
                  fill="url(#area-grad)"
                />
                <path
                  d="M0,60 Q15,30 30,55 T60,25 T90,65 L100,45"
                  fill="none"
                  stroke="currentColor"
                  strokeWidth="2"
                  strokeLinecap="round"
            ...
            <div className="relative w-40 h-40 shrink-0">
              <svg className="w-full h-full transform -rotate-90" viewBox="0 0 100 100">
                ...
                <circle
                  ...
                  strokeWidth="12"
                />
                {/* Animated shimmer-like colored arcs */}
                <circle
                  cx="50"
                  cy="50"
                  r="38"
